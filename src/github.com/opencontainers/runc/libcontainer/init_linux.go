...
func newContainerInit(t initType, pipe *os.File) (initer, error) {
	fmt.Println("[libcontainer] newContainerInit()...")
	var config *initConfig
	//n, err := io.Copy(pipe, os.Stdout)
	// if err != nil {
	// 	fmt.Println("[libcontainer] copy error:", n, err)
	// }
	// fmt.Println("[libcontainer] copy'd", n, "bytes")
	if err := json.NewDecoder(pipe).Decode(&config); err != nil {
		fmt.Printf("[libcontainer] error decoding json config: %#v\n", err)
		return nil, err
	}
	fmt.Println("[libcontainer] populateProcessEnvironment...")
