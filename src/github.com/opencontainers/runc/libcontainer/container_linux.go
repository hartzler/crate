...
func (c *linuxContainer) Start(process *Process) error {
	fmt.Println("[libcontainer] linuxContainer Start():", process)
	c.m.Lock()
	defer c.m.Unlock()
	...
	fmt.Println("[libcontainer] starting parent process:", parent)
	if err := parent.start(); err != nil {
		// terminate the process to ensure that it properly is reaped.
		fmt.Println("[libcontainer] starting parent process error:", err)
...
func (c *linuxContainer) newParentProcess(p *Process, doInit bool) (parentProcess, error) {
	fmt.Println("[libcontainer] newParentProcess...")
...
func (c *linuxContainer) commandTemplate(p *Process, childPipe *os.File) (*exec.Cmd, error) {
	...
	fmt.Println("[libcontainer] commandTemplate", cmd)
	cmd.Stdin = p.Stdin
	cmd.Stdout = p.Stdout
	cmd.Stderr = p.Stderr
...
func (c *linuxContainer) newInitProcess(p *Process, cmd *exec.Cmd, parentPipe, childPipe *os.File) (*initProcess, error) {
	fmt.Println("[libcontainer] newInitProcess...")
